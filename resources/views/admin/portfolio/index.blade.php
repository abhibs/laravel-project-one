...
@section('content')
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Portfolio Data</li>
        </ol>
    </nav>
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Portfolio Data</h6>
                                ...
                                @foreach ($datas as $key => $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if ($item->status == 1)
                                                <a href="{{ route('portfolio-inactive', $item->id) }}"
                                                    class="btn btn-outline-info" title="Inactive"><i
                                                        class="fa-solid fa-thumbs-down"></i> </a>
                                            @else
                                                <a href="{{ route('portfolio-active', $item->id) }}"
