    ...
    <div class="row profile-body">
        ...
        <div class="col-md-12 col-xl-12 middle-wrapper">
            <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title">Add Team </h6>


                        <form method="post" action="{{ route('team-store') }}" id="myForm" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="content" class="form-control" id="tinymceExample" rows="3"></textarea>
